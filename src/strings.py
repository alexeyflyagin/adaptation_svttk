...
LOG_IN__WARNING = f"""⚠️  <b>Внимание:</b> Убедитесь, что вы сохранили ключ доступа для входа в этот аккаунт в следующий раз!

Сохранить ключ: /myaccount » {BTN_ACCESS_KEY}
...
TRAINING_PROGRESS__COMPLETED = f"""<b>Поздравлем вас!</b> Вы успешно завершили курс 
'<code>{{training_name}}</code>'. 
