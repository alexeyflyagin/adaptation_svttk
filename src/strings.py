...
BTN_TRAINING_CLEAR_DATA = "🔄  Очистить данные"
BTN_BEGIN = "Начать!"
...
TRAINING__STARTED__ERROR__STARTED = """Ошибка! Курс запущен. Сначал нужно остановить его."""

TRAINING__STOPPED = """Курс успешно остановлен!"""

TRAINING__CLEARED = """Курс успешно очищен!"""
...
TRAINING__CLEAR_DATA = f"""<b>Убедитесь, что вы выгрузили (если это необходимо) отчёт о текущем прогрессе учеников!</b>

После подтверждения действия, <b>будут удалены все ученики и данные о них</b>!

<i>Данное действие необходимо для согласованности данных!</i>
—
Вы действительно хотите очистить все данные курса
'<code>{{training_name}}</code>'?"""
...
STUDENT_DELETE = f"""После подтверждения действия, <b>ученик и данные о нём будет навсегда удалены!</b>
—
Вы действительно хотите удалить ученика
'<code>{{full_name}}</code>'?"""

STUDENT_DELETED = f"""Ученик {{full_name}} успешно удалён!"""
